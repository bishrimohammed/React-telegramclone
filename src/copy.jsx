                ...
                <div className="inmessage d-flex flex-row mb-2 justify-content-start">
                  ...
                  <div className="px-2 ms-3 mb-1 position-relative   bg-white ">
                    <p className="mb-0 small ">
                      ...
                      excepturi eum possimus perferendis deserunt, vel, veniam
                      corrupti neque expedita molestias illo inventore vitae
                      distinctio nobis! Animi?Lorem ipsum, dolor sit amet
                      consectetur adipisicing elit. Temporibus ea quaerat sunt,
                      delectus excepturi eum possimus perferendis deserunt, vel,
                      veniam corrupti neque expedita molestias illo inventore
                      vitae distinctio nobis! Animi?
                    </p>
                ...
                <div className=" outmesssage d-flex mb-2 flex-row justify-content-end">
                  <div className="px-2 me-3 mb-1 d-flex flex-column  text-white position-relative  bg-primary">
                    <p className="small mb-0 ">
                      ...
                      Temporibus ea quaerat sunt, delectus excepturi eum
                      possimus perferendis deserunt, vel, veniam corrupti neque
                      expedita molestias illo inventore vitae distinctio nobis!
                      Animi?molestias illo inventore vitae distinctio nobis!
                      Animi?molestias illo inventore vitae distinctio nobis!
                      Animi? gukjhvjgh v
                      jhgvbjhdbkajsbhlkjslbakjbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
                    </p>
